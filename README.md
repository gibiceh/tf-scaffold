...
```powershell
git clone --depth=1 git@github.com:gibiceh/tf-scaffold.git scaffold
...
function scaffold {
   ...
   git clone --depth=1 --branch=$branch git@github.com:gibiceh/tf-scaffold.git "$name"
...
```cli
git clone --depth=1 git@github.com:gibiceh/tf-scaffold.git PROJECT_NAME | rm !$/.git -rf
```
...
echo "git clone --depth=1 --branch $branch git@github.com:gibiceh/tf-scaffold.git $name"
git clone --depth=1 --branch $branch git@github.com:gibiceh/tf-scaffold.git $name
rm -rf $name/.git
}
```
...
git clone --depth=1 git@github.com:gibiceh/tf-scaffold.git terraform-aws-generic
